...
OUT_ROOT="$ROOT/runs/linac_6mv_headneck_detailed_voxel_lattice_sfrt_phase17_vascular_sink_hugging_1e5"
...
python3.12 "$SCRIPT" \
  ...
  --histories 100000 \
  --threads 8 \
  --candidate-top-k-centers 24 \
  --candidate-plan-limit 6 \
  --vascular-candidate-multiplier 2 \
  --pde-steps 400 \
  --allow-infeasible-fallback \
  --course-strategy vascular_sink_hugging \
  --reuse-baseline-dose \
  "$@"
