...
OUT_ROOT="$ROOT/runs/linac_6mv_headneck_detailed_voxel_lattice_sfrt_phase23_robust_uncertainty_1e5"
...
env \
  ...
  python3.12 "$ROOT/scripts/run_phase23_robust_uncertainty_optimization.py" \
  --run-root "$OUT_ROOT" \
