...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--histories-base", type=int, default=1_000_000)
    parser.add_argument("--histories-spot", type=int, default=2_000_000)
