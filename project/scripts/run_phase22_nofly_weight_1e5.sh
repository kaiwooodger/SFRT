...
OUT_ROOT="$ROOT/runs/linac_6mv_headneck_detailed_voxel_lattice_sfrt_phase22_nofly_weight_1e5"
...
env \
  ...
  python3.12 "$ROOT/scripts/run_phase22_nofly_weight_optimization.py" \
  --run-root "$OUT_ROOT" \
