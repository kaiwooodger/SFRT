...
OUT_ROOT="$ROOT/runs/linac_6mv_headneck_detailed_voxel_lattice_sfrt_phase24_joint_horizon_diversity_1e5"
...
env \
  ...
  python3.12 "$ROOT/scripts/run_phase24_joint_horizon_diversity_optimization.py" \
  --run-root "$OUT_ROOT" \
