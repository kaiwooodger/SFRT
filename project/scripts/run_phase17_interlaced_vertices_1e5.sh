...
OUT_ROOT="$ROOT/runs/linac_6mv_headneck_detailed_voxel_lattice_sfrt_phase17_interlaced_vertices_1e5"
...
python3.12 "$SCRIPT" \
  ...
  --course-strategy reduced_vertices_interlaced \
  --interlaced-vertices-per-fraction 2 \
  "$@"
